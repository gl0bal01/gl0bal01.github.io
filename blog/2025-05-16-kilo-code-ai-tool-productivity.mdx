...
keywords: [kilocode, ai coding agent, vs code extension, open source ai, coding automation, developer productivity, ai pair programming, code generation, vscode ai tools]
date: 2025-05-16
---
...
---
<Youtube videoId="MfuCYNaPWTQ" start={8} />
---
## Why Kilocode?
